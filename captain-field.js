(() => {
  ...
  function ensureStyles() {
    ...
    style.textContent = `
      ...
      .field-player{position:absolute;transform:translate(-50%,-50%);z-index:2;width:28%;min-width:92px;max-width:155px;text-align:center;background:#fff;border:2px solid var(--a);border-radius:14px;padding:6px 7px;box-shadow:0 3px 10px #0002}
    ...
    if (!wrapper) {
      ...
      wrapper.innerHTML = `
        <div class="card field-status">
          <div><strong>Live Field Layout</strong><div class="muted">Captain only • updates automatically when you change a position</div></div>
