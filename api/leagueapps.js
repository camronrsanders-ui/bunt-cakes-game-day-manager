...
function parseIcsDate(prop='') {
  ...
  // LeagueApps exports UTC timestamps for this Stonewall Boston feed.
  // Convert UTC to Boston local time so the app matches the published schedule,
  // including the EDT -> EST change in November.
  if (m[7] === 'Z') {
