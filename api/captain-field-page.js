...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    html = html.replace('</head>', '<script src="/tenant-context.js?v=2"></script><link rel="stylesheet" href="/captain-console-layout.css?v=4"></head>');
    html = html.replace(
