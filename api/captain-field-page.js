...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    html = html.replace('Group players who can rotate through the same positions. Set the pod, then build the 7-inning plan so everyone can see who swaps and who rests.', 'Build the seven innings from pod assignments, attendance, and Captain decisions.');
    html = html.replace('Add Pod', 'Field Setup');
    html = html.replace('Build 7-Inning Rotation', 'Build Rotation');
