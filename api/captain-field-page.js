...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    html = html.replace('Group players who can rotate through the same positions. Set the pod, then build the 7-inning plan so everyone can see who swaps and who rests.', 'Set a primary and switch player for each position. Entering a switch makes that pair alternate by inning.');
