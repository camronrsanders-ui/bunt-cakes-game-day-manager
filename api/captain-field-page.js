module.exports = async function handler(req, res) {
  ...
  try {
    ...
    html = html.replace('</body>', freshLeagueApps + '<script src="/captain-field.js?v=1"></script><script src="/captain-access.js?v=1"></script><script src="/captain-pods-organizer.js?v=1"></script><script src="/captain-kicking.js?v=1"></script><script src="/captain-live-sync.js?v=2"></script></body>');
