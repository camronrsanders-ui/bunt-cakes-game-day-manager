...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    html = html.replace('</head>', '<script src="/tenant-context.js?v=3"></script><link rel="stylesheet" href="/captain-console-layout.css?v=5"></head>');
    html = html.replace(
